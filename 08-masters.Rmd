...
... is a direct descendant of the rather strange looking machine in figure \@ref(fig:tomfred-fig). In 2023, the BBC published archive footage of Tom Kilburn being interviewed by [Brian Redhead](https://en.wikipedia.org/wiki/Brian_Redhead) in 1981 about the machine and its successors, shown in figure \@ref(fig:redhead-fig)
...
```
(ref:redheadcaption) Broadcaster [Brian Redhead](https://en.wikipedia.org/wiki/Brian_Redhead) interviews proud Yorkshireman (and Manchester United fan) Tom Kilburn in 1981. [youtu.be/CQ2EBw7AgZY](https://youtu.be/CQ2EBw7AgZY) [@youtube-redhead]
