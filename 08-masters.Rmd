...
```
(ref:redheadcaption) Broadcaster [Brian Redhead](https://en.wikipedia.org/wiki/Brian_Redhead) interviews proud Yorkshireman and Manchester United fan Tom Kilburn in 1981. [youtu.be/CQ2EBw7AgZY](https://youtu.be/CQ2EBw7AgZY) [@youtube-redhead] This clip looks *very* dated now but provides an interesting window on the past. 

You don't need to be a Manchester United supporter or from Yorkshire to appreciate computing. A little basic arithmetic helps illustrate how far we've come since 1948 and 1981.
