...
```{r echo = FALSE, fig.align = "center", fig.cap = "Paying homage to [Alan Turing](https://en.wikipedia.org/wiki/Alan_Turing) at a mural on the [Princess Parkway](https://en.wikipedia.org/wiki/A5103_road) in Manchester by [tankpetrol.com](http://tankpetrol.com/) [@manturing]", out.width = "100%"}
