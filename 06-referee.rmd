...
This is a question academics get asked a lot. As industrial experience and employability tutor, I get asked that question a lot and already write *lots* of references for students applying for jobs and further study, see figure \@ref(fig:referee-fig). 
...
Unfortunately, like you, my time is a precious and finite resource. So I can write a reference for you [if and only if](https://en.wikipedia.org/wiki/If_and_only_if): 
