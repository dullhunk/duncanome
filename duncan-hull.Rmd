...
```{r beatles-fig, echo = FALSE, fig.align = "center", out.width = "70%", fig.cap='Tuning Complete consists of Jez Lloyd, Steve Furber, Justin Timberlake and me. We have an agile and constantly evolving membership model which means we are still waiting for Justin to turn up like he _promised_  he would in rehearsals'}
