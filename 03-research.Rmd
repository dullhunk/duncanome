...
My research interests are in [Computer Science Education](https://en.wikipedia.org/wiki/Computer_science_education) and [pedagogy](https://en.wikipedia.org/wiki/Pedagogy). [@CERhandbook; @JohnBiggs2011; @Fry2014] I'm interested in methods that can improve learning and student experience using techniques like [journal clubbing](https://sigcse.cs.manchester.ac.uk/), [industrial mentoring](https://www.cs.manchester.ac.uk/connect/business-engagement/industrial-mentoring/), [live music](#tuningcomplete), [working with schools](http://www.cs.man.ac.uk/~hulld/coding-their-future.html), [vertical tutoring](http://www.cs.man.ac.uk/~hulld/vertical-tutoring.html), [editing Wikipedia](#wikipedia) and more.
...
We are currently piloting a vertical tutoring (VT) scheme, see [vertical tutoring](http://www.cs.man.ac.uk/~hulld/vertical-tutoring.html) for details. [@vtbernard; @druryvert]
