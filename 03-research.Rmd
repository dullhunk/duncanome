...
## Tuning complete
Tuning complete are a [boy band](https://en.wikipedia.org/wiki/Boy_band) from [Manchester, Lancashire 🌹](https://duncan.hull.name/2019/07/05/mancashire/), named after the famous Computer Scientist [Alan Tuning](https://en.wikipedia.org/wiki/Alan_Turing). We use his eponymous [Tuning machine](https://en.wikipedia.org/wiki/Turing_machine) and [Tuning test](https://en.wikipedia.org/wiki/Turing_test) in our live performances. As of 2020, our lineup includes the following artists:
...
We are called *Tuning Complete* because theoretically we are [Turing Complete](https://en.wikipedia.org/wiki/Turing_completeness). [@Turing1937; @turingcomplete] Practically and artistically, this means that what we lack in youth, good looks, fame, fortune, fashion sense, fanbase and back catalogue we compensate for with:
