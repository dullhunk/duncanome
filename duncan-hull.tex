...
\endhead
\multirow{2}{*}{==========================
Size} & \multirow{2}{*}{\begin{minipage}[t]{\linewidth}\raggedright
\hypertarget{baby-in-1948}{%
\chapter{Baby in 1948}\label{baby-in-1948}}

Filled a medium sized room
\end{minipage}} & \multirow{2}{*}{\begin{minipage}[t]{\linewidth}\raggedright
\hypertarget{arm-in-2000}{%
\chapter{ARM in 2000}\label{arm-in-2000}}

fills 7mm by 3mm of silicon
\end{minipage}} & \\
& & & \\
...
Energy efficiency
(Joules per instruction) & 5 & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.5000} + 2\tabcolsep}@{}}{%
0.000 000 002 \textbar{}
