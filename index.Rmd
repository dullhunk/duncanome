...
## Toolbox  {-}
This website^[last updated `r format(Sys.time(), '%d %B, %Y')`] is built using [bookdown](https://bookdown.org) with [R markdown](https://rmarkdown.rstudio.com/), the [R language](https://en.wikipedia.org/wiki/R_(programming_language)), [gitbook](https://www.gitbook.com), [JavaScript](https://en.wikipedia.org/wiki/JavaScript), [knitr](https://en.wikipedia.org/wiki/Knitr), [LaTeX](https://en.wikipedia.org/wiki/LaTeX), [Pandoc](https://pandoc.org/), [RStudio](https://www.rstudio.com/) and TLC. Thanks to [Yihui Xie](https://yihui.name/) and his collaborators for the handy tools and excellent documentation. The [source is available on github](https://github.com/dullhunk/hulled), but you'll be better off reading the *friendly* manual (RTFM) *[Authoring Books and Technical Documents with R Markdown](https://bookdown.org/yihui/bookdown/)* first. If you're viewing this on an iPhone or iPad, there is [known bug with the menu bar at the top of this page](https://github.com/rstudio/bookdown/issues/60) which means the menu might not display properly. This page is also available [as a pdf](http://www.cs.man.ac.uk/~hulld/duncan-hull.pdf) and [and an ebook](http://www.cs.man.ac.uk/~hulld/duncan-hull.epub).
