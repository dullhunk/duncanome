...
\tightlist
\item
  There are three really good books to help you get started
  ...
  \end{itemize}
\item
  FutureLearn.com courses to get you started:
  ...
  \end{itemize}
\item
  \emph{SIGCSE events} The UK Special Interest Group (SIG) on Computer Science Education (CSE) has monthly events listed online at \href{https://uki-sigcse.acm.org/events}{uki-sigcse.acm.org/events}
\item
