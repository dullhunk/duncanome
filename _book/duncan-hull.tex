...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 09 May, 2025},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 09 May, 2025}
\date{}
...
\caption{A panoramic picture of the South entrance of the \href{https://en.wikipedia.org/wiki/Kilburn_Building}{Kilburn building} on Wilton Street with the \href{https://en.wikipedia.org/wiki/Wilmslow_Road}{Oxford Road} on the left and the \href{https://en.wikipedia.org/wiki/Alan_Turing_Building}{Alan Turing Building} on the right hand side of the picture. CC BY SA picture from Wikimedia Commons.}\label{fig:kilburnsouth-fig}
\end{figure}
