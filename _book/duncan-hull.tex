...
\caption{``You know Fred once we've debugged this code, we're straight down the discotheque to dance the night away with the \href{https://en.wikipedia.org/wiki/Bee_Gees}{Bee Gees}. Gimme that night fever, \href{https://en.wikipedia.org/wiki/Night_Fever}{night fever}, we know how to show it.''}\label{fig:mu5-fig}
\end{figure}
