...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 14 February, 2026},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 14 February, 2026}
\date{}
...
We are working hard to improve the employability of students because while having a Computer Science is necessary for some jobs, it is not sufficient. \citep{unemployed, shadboltreview, fincherreview, finchergecco} Over the last decade we have been successful in \emph{more than doubling} the number of our students going on year long placements in industry to around 100 per year, see figure \ref{fig:ie-fig}. The IE program is now the largest elective program of Industrial Experience in the University, see figure \ref{fig:csreputation-fig}. This is a win-win-win situation for:
...
{\centering \includegraphics[width=1\linewidth]{duncan-hull_files/figure-latex/csreputation-fig-1} 
