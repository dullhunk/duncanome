...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 29 January, 2024},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 29 January, 2024}
\date{}
...
{\centering \includegraphics[width=1\linewidth]{images/high-fliers-table-2023} 

}

\caption{According to \href{https://www.highfliers.co.uk}{highfliers.co.uk}, the University of Manchester is the most targeted University in the UK by the \href{https://www.top100graduateemployers.com}{Times Top 100 Graduate Employers} \citep{highfliers2023}}\label{fig:busy-fig}
\end{figure}
...
Please indicate in email by stating that you are COMPSCI
