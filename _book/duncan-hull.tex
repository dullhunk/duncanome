...
\item
  Improving students written communication skills activities like \href{https://www.cdyf.me/hacking.html}{CV hacking} and \protect\hyperlink{wikipedia}{Wikipedia editing \& training}
\item
...
\caption{The class of 2003. Most of these people have moved on, although some stuck around to do research including \href{https://web.stanford.edu/~horridge/}{Matthew Horridge}, Michael Parkin, Karim Nashar and myself (the one in the back row standing highest)}\label{fig:msc-fig}
\end{figure}
...
\caption{``You know Jim once we've debugged this code, we're straight down the discotheque to dance the night away with the \href{https://en.wikipedia.org/wiki/Bee_Gees}{Bee Gees}. Gimme that night fever, \href{https://en.wikipedia.org/wiki/Night_Fever}{night fever}, we know how to show it.''}\label{fig:mu5-fig}
\end{figure}
...
Which is a good point to close this essay on.\footnote{Originally written in about 2004, too much mansplaining updated from \url{https://web.archive.org/web/20180729110412/http://www.cs.man.ac.uk/~hulld/msc2003.html}}
