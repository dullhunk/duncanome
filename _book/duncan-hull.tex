...
I \protect\hyperlink{teaching}{teach} undergraduate courses, supervise tutorials, final year projects and masters projects. I serve as \href{http://studentnet.cs.manchester.ac.uk/ugt/year2/}{second year tutor}, \href{http://studentnet.cs.manchester.ac.uk/employment/placement/}{employability tutor}, while also serving on the \href{http://www.studentsupport.manchester.ac.uk/study-support/mitigating-circumstances/}{mitigating circumstances} committee and exam boards. I'm interested in methods that can \protect\hyperlink{research}{deliver high quality learning and student experience} by using innovative techniques like \protect\hyperlink{vertical-tutoring-1}{vertical tutoring}, \href{https://www.cs.manchester.ac.uk/connect/business-engagement/industrial-mentoring/}{industrial mentoring}, \href{https://en.wikipedia.org/wiki/Live_coding}{live coding}, \protect\hyperlink{wikipedia}{Wikipedia editing} and \protect\hyperlink{tuning-complete}{live music}. 🎸
...
\caption{Posing on the [BBC Breakfast Sofa](https://twitter.com/bbcbreakfast) with the winning team of the BBC / Barclays University technology challenge in MediaCityUK, Salford}\label{fig:unnamed-chunk-3}
\end{figure}
...
We're working hard to improve the employability of students because while having a Computer Science is necessary for some jobs, it is not sufficient. \citep{unemployed, shadboltreview, fincherreview, finchergecco} Over the last 10 years the Department has tripled the number of our students going on year long placements in industry, but there's still more we can do to improve the employability of our graduates. If you'd like to help our graduate become more employable, get in touch.

\hypertarget{research}{%
\chapter{Research}\label{research}}

My research interests are in \href{https://scholar.google.com/citations?view_op=search_authors\&hl=en\&mauthors=label:computer_science_education}{Computer Science Education} (CSE)\footnote{There are at least two synonyms (labels) for this in Google scholar: \href{https://scholar.google.com/citations?view_op=search_authors\&hl=en\&mauthors=label:computer_science_education}{Computer Science Education} and \href{https://scholar.google.com/citations?view_op=search_authors\&hl=en\&mauthors=label:computing_education}{Computing Education}, take your pick.} and \href{https://en.wikipedia.org/wiki/Pedagogy}{pedagogy}. \citep{JohnBiggs2011, Fry2014} I'm interested in methods that can deliver high quality learning and student experience using innovative techniques like \protect\hyperlink{vertical-tutoring-1}{vertical tutoring}, \href{https://www.cs.manchester.ac.uk/connect/business-engagement/industrial-mentoring/}{industrial mentoring}, \protect\hyperlink{tuning-complete}{live music}, \href{https://en.wikipedia.org/wiki/Live_coding}{live coding}, \protect\hyperlink{wikipedia}{Wikipedia editing} and more.
...
Wikipedia and \href{https://www.wikidata.org}{wikidata.org} \citep{Vrandecic2014, Turki2019} are powerful tools for improving both digital skills and communication skills, regardless of your age or level of computer literacy. \citep{Proffitt2018, goodfaith} As an experienced and long serving editor of Wikipedia since 2004, I organise and participate in \href{https://en.wikipedia.org/wiki/Edit-a-thon}{edit-a-thons} which recruit and train new Wikipedia editors. \citep{Hodson2015, goodbadugly, troubled, findingada2019} Some examples include:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  2019-10-19 \href{https://wiki-loves-scientists.org.uk/2019/10/09/learn-to-edit-wikipedia-thurs-17th-october-university-of-manchester-all-welcome/}{Learn to edit Wikipedia, University of Manchester}, Sackville Street Building
\item
  2019-10-12 \href{https://www.eventbrite.com/e/global-wikipedia-edit-a-thon-wikieditathon-2019-manchester-and-london-2019-zebra-hub-hq-the-tickets-48601581639}{The Pankhurst Centre and Ada. National College for Digital Skills}
\item
  2017-
\item
  2015-
...
Tuning complete is a \href{https://en.wikipedia.org/wiki/Boy_band}{boy band} from Manchester, Lancashire whose lineup includes:
...
\item
  \href{https://en.wikipedia.org/wiki/Steve_Furber}{Steve Furber} (six string and bass)
\item
  \href{https://en.wikipedia.org/wiki/Justin_Timberlake}{Justin Timberlake} (lead vocals, lead dancer)
\item
  myself (MC, \href{https://sonic-pi.net/}{sonic-pi} and embarassing dad dancing) \citep{daddancing}
\end{itemize}

We are called \emph{Tuning Complete} because technically speaking we are \href{https://en.wikipedia.org/wiki/Turing_completeness}{Turing Complete}. \citep{Turing1937, turingcomplete} Artistically, this means that what we lack in youth, good looks, fame, fortune, fanbase and back catalogue we compensate for with:
...
\caption{Tuning Complete consists of Jez Lloyd, Steve Furber, Justin Timberlake and me. We have a fluid, agile and constantly evolving membership model which means we are still waiting for Justin to turn up like he promised he would in rehearsals}\label{fig:unnamed-chunk-8}
\end{figure}

We played our debut gig to a packed theatre of over 200 second year undergraduate computer science students in the \href{https://en.wikipedia.org/wiki/Department_of_Chemistry,_University_of_Manchester}{Department of Chemistry} in September 2019 and are currently planning future live events while writing a \href{https://en.wikipedia.org/wiki/List_of_Christmas_hit_singles_in_the_United_Kingdom}{lucrative Christmas hit single} working title: \href{https://twitter.com/hashtag/LivingTheDream}{\#LivingTheDream}. If you would like to book our services for your next event, hackathon, wedding, bar mitzvah etc, please contact our agent Mrs.~Kilburn. She currently divides her time between the \href{https://www.cs.manchester.ac.uk/about/maps-and-travel/}{Kilburn building} and the \href{https://www.manchesterwi.org.uk/}{Manchester Womens' Institute}.
...
\caption{Mrs. Kilburn is our manager, booking agent and promoter. She is the power behind our boy band throne, so all bookings must be approved and scheduled by her office. Please do not approach band members directly with gig requests or offers of marriage, we are all taken!}\label{fig:unnamed-chunk-9}
\end{figure}
...
Coding their future is a collaboration \& partnership between secondary schools and the \href{https://www.cs.manchester.ac.uk/}{Department of Computer Science} at the University of Manchester. Our aim is to improve and support Computer Science education at key stages 3, 4 and 5. \citep{shutdownrestart, afterthereboot, cse, cambridgegcse}
...
\item
  \href{https://www.chhs.org.uk/}{Cheadle Hulme High School}, (CHHS) Stockport (not to be confused with the private \href{https://www.cheadlehulmeschool.co.uk/}{Cheadle Hulme School})
\item
...
\caption{A lecture theatre full of first year students}\label{fig:unnamed-chunk-13}
\end{figure}
...
\textbackslash{}caption\{Paying homage to \href{https://en.wikipedia.org/wiki/Alan_Turing}{Alan Turing} at a mural on the \href{https://en.wikipedia.org/wiki/A5103_road}{Princess Parkway} in Manchester by \href{http://tankpetrol.com/}{tankpetrol.com}\}\label{fig:unnamed-chunk-14}
\textbackslash{}end\{figure\}
