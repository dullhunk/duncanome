...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 05 April, 2024},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 05 April, 2024}
\date{}
...
\caption{Posing outside the \href{https://en.wikipedia.org/wiki/Googleplex}{Googleplex} in California. Thanks to \href{https://www.linkedin.com/in/andrewlang}{Andrew Lang} for taking this picture during \href{https://en.wikipedia.org/wiki/Science_Foo_Camp}{Science Foo Camp} back in the more optimistic days on 2009 before we wanted to wrestle computation back from \href{https://en.wikipedia.org/wiki/Big_Tech}{Big Tech}. \citep{internetcon}}\label{fig:unnamed-chunk-9}
\end{figure}
