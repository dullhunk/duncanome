...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 21 June, 2024},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 21 June, 2024}
\date{}
...
\addcontentsline{toc}{section}{What's Your Story?}
...
This is a question academics get asked a lot. As industrial experience and employability tutor, I get asked that question a lot and already write \emph{lots} of references for students applying for jobs and further study, see figure \ref{fig:referee-fig}.
...
You can get in touch with me (and my colleagues) using the details below, which include my contact details, directions to the Kilburn Buidling and parking information.
...
\section{Duncan's Digital Doppelgangers}\label{tinternet}}
