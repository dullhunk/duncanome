...
We are called \emph{Tuning Complete} because theoretically we are \href{https://en.wikipedia.org/wiki/Turing_completeness}{Turing Complete}. \citep{Turing1937, turingcomplete} Practically and artistically, this means that what we lack in youth, good looks, fame, fortune, fashion sense, fanbase and back catalogue we compensate for with:
...
We played our debut gigs to packed theatres of over 200 second year \& first year undergraduate computer science students in the autumn of 2019 and are currently planning future live events while writing a (hopefully) lucrative hit single, working title: \href{https://twitter.com/hashtag/LivingTheDream}{\#LivingTheDream}. If you would like to book our services for your next event, hackathon, wedding, bar mitzvah etc, please contact our agent Mrs.~Kilburn shown in Figure\textasciitilde\ref{fig:mrskilburn-fig}.
