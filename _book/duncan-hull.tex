...
\caption{This is me superimposed on a background photo by [slidebean](https://unsplash.com/@slidebean) on [unsplash.com](https://unsplash.com), a source of [freely-usable images](https://unsplash.com/license).}\label{fig:unsplashed-fig}
\end{figure}
