...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 21 April, 2026},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 21 April, 2026}
\date{}
...
Hello and welcome to the \href{https://www.cs.manchester.ac.uk/}{Department of Computer Science} at the \href{https://www.manchester.ac.uk}{University of Manchester}. My \href{https://en.wikipedia.org/wiki/Duncan_(given_name)}{name is Duncan} and I'm a Senior Lecturer (\href{https://en.wikipedia.org/wiki/Associate_professor}{Associate Professor}) and Employability Lead. I \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/teaching}{teach} undergraduate \& postgraduate students, supervise tutorials \& projects while serving as chair of board of the \href{https://www.se.manchester.ac.uk/about/schools-and-departments/school-of-engineering/}{School of Engineering} and a member of \href{https://www.manchester.ac.uk/discover/governance/structure/senate/}{University senate}. I'm interested \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/research}{improving teaching, learning and the student experience} by:
...
\item
  Engaging with a wide range of employers through our industry club at \href{https://industry-club.cs.manchester.ac.uk}{industry-club.cs.manchester.ac.uk}
\item
  Serving on the board of \href{https://uki-sigcse.acm.org}{UK ACM SIGCSE} and building the teaching community around it by \href{https://uki-sigcse.acm.org/journal-club/}{journal clubbing}
\item
  Supporting local schools both as a school governor and with the project \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/coding-their-future}{Coding Their Future}
\item
  Updating students weekly on opportunities with the Wednesday Waggle newsletter at \href{https://waggle.cs.manchester.ac.uk}{waggle.cs.manchester.ac.uk} 🐝
\end{itemize}

Our elective has \href{https://industry-club.cs.manchester.ac.uk/experience.html}{Industrial Experience (IE)} program is the largest at the University with up to 100 students every year working in paid employment for the penultimate (``sandwich'') year-in-industry of their undergraduate degrees. If you are an \href{https://industry-club.cs.manchester.ac.uk}{employer} who would like to recruit a summer intern, placement student, part-timer or graduate please \href{https://industry-club.cs.manchester.ac.uk/contact.htmld}{get in touch}.

\section*{Full stack teaching}\label{full-stack-teaching}
\addcontentsline{toc}{section}{Full stack teaching}

Regardless of the age or the stage, I enjoy the challenges of teaching and have taught english, maths, science and engineering to primary \& secondary school children, undergraduates \& postgraduates. In 2011, I completed a \href{https://en.wikipedia.org/wiki/Postgraduate_Certificate_in_Education}{Postgraduate Certificate in Education} (PGCE) at the \href{https://www.bath.ac.uk/}{University of Bath} and served as a high school science teacher in co-educational \href{https://www.gov.uk/types-of-school}{comprehensive (non-selective) state schools} in Swindon, Shaftesbury and Stockport before returning to higher education. I serve as a \href{https://www.manchester.ac.uk/connect/teachers/school-governors/}{school governor} on the governing board of a school in Greater Manchester. As well as teaching in the UK I have also taught in India, Japan and America too. 🇪🇺🇬🇧🇮🇳🇯🇵🇺🇸

\section*{What's the Story, Jackanory?}\label{whats-the-story-jackanory}
\addcontentsline{toc}{section}{What's the Story, Jackanory?}

So what's the story, \href{https://en.wikipedia.org/wiki/Jackanory}{Jackanory}? Born in \href{https://en.wikipedia.org/wiki/Bath,_Somerset}{Bath, Somerset} and raised using a \href{https://en.wikipedia.org/wiki/West_Country}{secret West Country recipe}, \href{https://uk.linkedin.com/in/duncanhull}{my story} is a mixture of Natural Science (\href{https://speakerdeck.com/dullhunk/why-study-plants}{Plant Sciences, BSc}), Computer Science (\href{mastersofscience.html}{MSc} \& \href{https://www.librarysearch.manchester.ac.uk/permalink/44MAN_INST/1r887gn/alma992976677936301631}{PhD}) and software engineering. Outside of academia, I've worked as a consultant and software developer for \href{https://en.wikipedia.org/wiki/BBC_Monitoring}{BBC Monitoring}, the \href{https://en.wikipedia.org/wiki/Ford_Motor_Company}{Ford Motor Company} and the \href{https://en.wikipedia.org/wiki/National_Health_Service}{National Health Service} (NHS). As an academic, I have been part of the \href{https://esciencelab.org.uk/}{e-Science lab}, \href{https://en.wikipedia.org/wiki/Apache_Taverna}{Apache Taverna} and \href{https://en.wikipedia.org/wiki/MyGrid}{myGrid} projects and completed a \href{https://en.wikipedia.org/wiki/Postdoctoral_researcher}{postdoc} at the \href{https://www.mib.manchester.ac.uk/}{Manchester Institute of Biotechnology} (MIB) on the \href{https://pubmed.ncbi.nlm.nih.gov/20529930/}{Pathtext project}. This was followed by a short stint as a software engineer of \href{https://en.wikipedia.org/wiki/ChEBI}{Chemical Entities of Biological Interest} (ChEBI) at the \href{https://en.wikipedia.org/wiki/European_Bioinformatics_Institute}{European Bioinformatics Institute} (EBI) in Cambridge, UK. 🧬👨‍🔬

\section*{Toolbox}\label{toolbox}
\addcontentsline{toc}{section}{Toolbox}

This website was built using \href{https://bookdown.org}{bookdown}, \href{https://en.wikipedia.org/wiki/Markdown}{markdown}, the \href{https://en.wikipedia.org/wiki/R_(programming_language)}{R language}, \href{https://en.wikipedia.org/wiki/JavaScript}{JavaScript}, \href{https://en.wikipedia.org/wiki/Knitr}{knitr}, \href{https://latex4year1.netlify.app}{LaTeX}, \href{https://en.wikipedia.org/wiki/Pandoc}{Pandoc}, \href{https://en.wikipedia.org/wiki/GitHub}{GitHub}, \href{https://en.wikipedia.org/wiki/RStudio}{RStudio} and TLC. The \href{https://github.com/dullhunk/duncanome}{source code is available} and the documentation in \emph{\href{https://bookdown.org/yihui/bookdown/}{Authoring Books and Technical Documents with R Markdown}}. These pages are also available \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/duncan-hull.pdf}{in one single pdf file} and \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/duncan-hull.epub}{and an ebook}. Thanks to \href{https://en.wikipedia.org/wiki/Yihui_Xie}{Yihui Xie} and his collaborators for the handy tools and excellent documentation. 🙏
...
If you'd like to debug your CV, application form, covering letter and job search etc, read \href{https://www.cdyf.me/debugging}{debugging your future} \citep{debugyourfuture} and \href{https://www.cdyf.me/hacking}{hacking your future} \citep{hackingyourfuture}, especially if you haven't written a CV, Résumé or LinkedIn profile before. Once you've checked your CV against short checklist at \href{https://www.cdyf.me/debugging\#quick}{cdyf.me/debugging\#quick} you can get feedback from me by submitting your CV (etc) at \href{https://bit.ly/debug-my-cv}{bit.ly/debug-my-cv} or using the QR code in figure \ref{fig:qr-fig}

\begin{figure}
\includegraphics[width=0.33\linewidth]{images/qr} \includegraphics[width=0.33\linewidth]{images/qr} \includegraphics[width=0.33\linewidth]{images/qr} \caption{Once you've self-checked your CV using \href{https://www.cdyf.me/debugging\#quick}{cdyf.me/debugging\#quick} you can get feedback by submitting your CV (etc) at \href{https://bit.ly/debug-my-cv}{bit.ly/debug-my-cv} (login required)}\label{fig:qr-fig}
\end{figure}
...
\tightlist
\item
  Academic staff member for \href{https://studentnet.cs.manchester.ac.uk/ugt/COMP10120/syllabus/}{First year team projects: COMP101} led by \href{https://research.manchester.ac.uk/en/persons/stewart.blakeway}{Stewart Blakeway} \citep{COMP10120}, see the \href{http://latex4year1.netlify.app}{getting started with LaTeX lab manual}
\item
...
If you're doing a Masters degree, you'll find me supervising \href{https://www.cs.manchester.ac.uk/study/masters/}{Master of Science} projects in Computer Science and Data Science. \citep{r4ds} This typically involves various combinations of Wikipedia, Wikdata, \href{https://en.wikipedia.org/wiki/SPARQL}{SPARQL} \citep{ducharme} and chatbots. 🤖 \citep{myca}
...
If you are an employer, graduates and undergraduates are an important part of the future of your organisation.
...
Collaborating with us in the Department of Computer Science is one of the best ways to encourage students from the University of Manchester to join your organisation as employees both before and after they graduate, see figure \ref{fig:graduating-your-fig}.

\section{Department of Computer Science Industry Club at the University of Manchester}\label{ic}

If you're not recruiting graduates, your organisation may suffer in the longer term as talented and young employees decide to work for other employers. Recruiting graduates is a cost effective way to build the skills and knowledge your organisation needs to succeed in the future. If you're an employer, you can find out more about how to engage with our students and staff on our industry club pages at \href{https://industry-club.cs.manchester.ac.uk/}{industry-club.cs.manchester.ac.uk}
...
Coding, programming, software engineering and computer science - whatever you want to call it, builds key foundational skills and knowledge that \textbf{all} students need to learn regardless of their aspirations. Children don't learn to code just to become coders, they learn to code so they can build problem solving skills and develop an understanding how the digital world they inhabit functions. \citep{peytoncode, kidscode}, creator of the \href{https://sonic-pi.net/}{sonic-pi.net} makes this case in figure \ref{fig:sonic-pi-fig}.
...
\bottomrule\noalign{}
\endlastfoot
\href{https://www.theeastmanchesteracademy.co.uk}{theeastmanchesteracademy.co.uk} & Beswick & \href{https://bit.ly/temac}{60.8\%} & \\
\href{https://www.manchestercommunicationacademy.com}{manchestercommunicationacademy.com} & Harpurhey & \href{https://bit.ly/mcommacad}{59.6\%} & \\
\href{https://wrhs1118.co.uk}{wrhs1118.co.uk} & Whalley Range & \href{https://bit.ly/wrhschool}{51.6\%} & \\
\href{https://burnage.manchester.sch.uk}{burnage.manchester.sch.uk} & Burnage & \href{https://bit.ly/burnage4boys}{49.7\%} & \\
\href{https://www.stpetershigh.com}{stpetershigh.com} & Longsight & \href{https://bit.ly/stpetershigh}{46.7\%} & \\
\href{https://www.stannes.academy}{stannes.academy} & Stockport & \href{https://bit.ly/stannesrc}{40.9\%} & \\
\href{https://www.didsburyhighschool.org.uk}{didsburyhighschool.org.uk} & Didsbury & \href{https://bit.ly/didsburyhigh}{40\%} & \\
\href{https://www.utcmediacityuk.org.uk}{utcmediacityuk.org.uk} & Salford & \href{https://bit.ly/4ateW1q}{41\%} & \\
\href{https://www.whgs-academy.org}{whgs-academy.org} & Whalley Range & \href{https://bit.ly/whgs}{39.1\%} & \\
\href{https://www.allhallowssalford.com}{allhallowssalford.com} & Salford & \href{https://bit.ly/allhallowshigh}{38.9\%} & \\
\href{https://thebarlowrchigh.co.uk}{thebarlowrchigh.co.uk} & Didsbury & \href{https://bit.ly/barlowrc}{38.8\%} & \\
\href{http://www.fairfieldhigh.tameside.sch.uk}{fairfieldhigh.tameside.sch.uk} & Droylsden & \href{https://bit.ly/fairfieldhigh}{33.4\%} & \\
\href{https://www.trinityhigh.com}{trinityhigh.com} & Hulme & \href{https://bit.ly/trinityhighs}{33.1\%} & \\
\href{https://pwhs.co.uk}{pwhs.co.uk} & Didsbury & \href{https://bit.ly/parrswoodhigh}{31.2\%} & \\
\textbf{``\href{http://news.bbc.co.uk/1/hi/education/4243035.stm}{Bog Standard Comprehensive}''} & \textbf{Anywhere} & \textbf{\href{https://bit.ly/bog-standard}{25.7\%}} & \\
\href{https://www.lauruscheadlehulme.org.uk}{lauruscheadlehulme.org.uk} & Cheadle Hulme & \href{https://bit.ly/laurusch}{18.9\%} & \\
\href{https://www.blue-coat.org}{blue-coat.org} & Oldham & \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2828} + 2\tabcolsep}@{}}{%
\href{https://bit.ly/bluecoat-oldham}{15.4\%}} \\
\href{https://www.stretfordgrammar.com}{stretfordgrammar.com} & Stretford & \href{https://bit.ly/stretfordg}{15} & \\
\href{https://www.knutsfordacademy.org.uk}{knutsfordacademy.org.uk} & Knutsford & \href{https://bit.ly/knutsacad}{13.1\%} & \\
\href{https://www.chhs.org.uk}{chhs.org.uk} & Cheadle Hulme & \href{https://bit.ly/cheadlehhs}{11\%} & \\
\href{https://www.agsb.co.uk}{agsb.co.uk} & Altrincham & \href{https://bit.ly/alty-boys}{5.4\%} & \\
\href{https://aggs.bright-futures.co.uk}{aggs.bright-futures.co.uk} & Altrincham & \href{https://bit.ly/alto-girls}{5.3\%} & \\
\href{https://www.mgs.org}{mgs.org} & Rusholme & 0\% & \\
\end{longtable}



The project was setup by \href{contact}{Duncan Hull} and \href{http://www.cs.man.ac.uk/~david/}{David Rydeheard} and is now led by Duncan. There are lots of open questions about how Computing should be taught. \citep{cse, suemcr, stephenson, fincherpetre} To find out more, see the \hyperref[guidance-for-teachers]{guidance for teachers} and \hyperref[guidance-for-students]{guidance for students} below.
...
\caption{Lecture theatre 1.1 (LT 1.1) in Kilburn full of first year students}\label{fig:unnamed-chunk-4}
\end{figure}
...
This is a question academics get asked a lot. As employability lead, I get asked that question more than most and already write \emph{lots} of references for students applying for jobs and further study, see figure \ref{fig:referee-fig}.
...
\tightlist
\item
  You have been my personal tutee in first, second, IE placement or final year
\item
...
You can obtain an unofficial copy of your transcript by emailing \texttt{soe.hub@manchester.ac.uk}.
...
So, as of 2025, Tuning Complete are a \href{https://en.wikipedia.org/wiki/Musical_collective}{musical collective} with a fluid membership model, we're always looking for new members to join our ensemble. Artists we have collaborated with include:
...
\begin{quote}
The future has arrived --- It's Just Not Evenly Distributed Yet. \citep{gibson}
\end{quote}

Unfortunately you can't contact the future, yet. While we wait for the future to become more evenly distributed you \emph{can} contact me using the information below which includes directions to the Kilburn Buidling and parking information.
...
\tightlist
\item
  The Undergraduate (UG) Virtual Common Room \href{https://bit.ly/UG-VC-2025-26}{bit.ly/UG-VC-2025-26} and links it contains, in particular:

  \begin{itemize}
  \tightlist
  \item
    The Undergraduate (UG) Handbook \href{https://bit.ly/UG-handbook-2025-26}{bit.ly/UG-handbook-2025-26}
  \item
    The Placement Handbook \href{https://bit.ly/placement-handbook-2025}{bit.ly/placement-handbook-2025}
  \item
    The Monday Mail \href{https://studentnet.cs.manchester.ac.uk/ugt/mondaymail}{studentnet.cs.manchester.ac.uk/ugt/mondaymail}
  \item
    The Wednesday Waggle (for jobs) \href{https://waggle.cs.manchester.ac.uk/waggle/login}{waggle.cs.manchester.ac.uk}
  \item
...
You can do this via \href{https://bit.ly/student-services-enquiry-form}{bit.ly/student-services-enquiry-form}
...
\caption{A panoramic picture of the \href{https://en.wikipedia.org/wiki/Kilburn_Building}{Kilburn building} which looks a like a giant brick \href{https://en.wikipedia.org/wiki/Heat_sink}{heat sink}. This picture is taken from the \href{https://en.wikipedia.org/wiki/Wilmslow_Road}{Oxford Road} showing \href{https://www.conference.manchester.ac.uk/venues/search/details/?property=10}{University Place} on the right, which looks like a giant tin of baked beans. Creative Commons \href{https://creativecommons.org/licenses/by/2.0/deed.en}{BY} Image by Yours Truly via Wikimedia Commons \href{https://w.wiki/E6Qk}{w.wiki/E6Qk}}\label{fig:kilburn-fig}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{images/kilburn-south-entrance-new-door} 

}

\caption{A panoramic picture of the South entrance of the \href{https://en.wikipedia.org/wiki/Kilburn_Building}{Kilburn building} on Wilton Street with the \href{https://en.wikipedia.org/wiki/Wilmslow_Road}{Oxford Road} on the left and the \href{https://en.wikipedia.org/wiki/Alan_Turing_Building}{Alan Turing Building} on the right hand side of the picture.}\label{fig:kilburnsouth-fig}
\end{figure}
...
The \href{https://en.wikipedia.org/wiki/Kilburn_Building}{Kilburn building} shown in figure \ref{fig:kilburn-fig} is about 15 minutes walk from \href{https://www.nationalrail.co.uk/stations_destinations/man.aspx}{Manchester Piccadilly} (MAN) or ten minutes from \href{https://www.nationalrail.co.uk/stations/mco/details.aspx}{Manchester Oxford Road} (MCO). Our official postcode (M13 9PL) takes you to \href{http://www.conference.manchester.ac.uk/venues/search/details/?property=10}{University Place} (which looks like a giant tin of baked beans) next door, so you're better off using the \href{https://www.bbc.co.uk/news/uk-england-49319760}{what3words locations} \citep{what3words} below which are more accurate:
...
\caption{How much of the future has already been written?}\label{fig:shelfie-fig}
\end{figure}
