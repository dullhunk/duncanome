...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 25 March, 2024},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 25 March, 2024}
\date{}
...
\href{https://pwhs.co.uk}{pwhs.co.uk} & Didsbury & \href{https://bit.ly/didsburyhigh}{35.6\%} \\
...
\caption{Lecture theatre 1.1 (LT 1.1) in Kilburn full of first year students}\label{fig:unnamed-chunk-7}
\end{figure}
...
\item
  📥 email: \href{mailto:soe.placements@manchester.ac.uk}{\nolinkurl{soe.placements@manchester.ac.uk}}
\end{itemize}

\hypertarget{other-contacts}{%
\section{Other contacts}\label{other-contacts}}
...
Student Experience & \href{mailto:soe.studentexperience@manchester.ac.uk}{\nolinkurl{soe.studentexperience@manchester.ac.uk}} \\
...
\caption{This is not the \href{https://en.wikipedia.org/wiki/Kilburn_Building}{Kilburn building}, this is the \href{https://en.wikipedia.org/wiki/Googleplex}{Googleplex} in California. Thanks to \href{https://www.linkedin.com/in/andrewlang}{Andrew Lang} for taking this picture during \href{https://en.wikipedia.org/wiki/Science_Foo_Camp}{Science Foo Camp} in 2009}\label{fig:unnamed-chunk-9}
\end{figure}
