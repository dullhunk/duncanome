...
\caption{The class of 2003. Most of these people have moved on, although some stuck around to do research including \href{https://web.stanford.edu/~horridge/}{Matthew Horridge}, Michael Parkin, Karim Nashar and myself (the one in the back row with the dodgy haircut)}\label{fig:msc-fig}
\end{figure}
...
\begin{longtable}[]{@{}lll@{}}
\caption{\label{tab:cputable} Advances in processor power 1948 to 2000. Thanks to Doug Edwards, Jim Garside and Steve Furber.}\tabularnewline
\toprule
