...
\hypersetup{
  ...
  pdfauthor={Yours truly, last updated on 03 March, 2025},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dr.~Duncan Hull}
\author{Yours truly, last updated on 03 March, 2025}
\date{}
...
If you'd like to debug your CV, application form, covering letter and job search etc, read \href{https://www.cdyf.me/debugging}{debugging your future} \citep{debugyourfuture} and \href{https://www.cdyf.me/hacking}{hacking your future} \citep{hackingyourfuture}, especially if you haven't written a CV, Résumé or LinkedIn profile before. Once you've done this you can:

\begin{itemize}
\tightlist
\item
  Get feedback by submitting your CV (etc) at \href{https://bit.ly/debug-my-cv}{bit.ly/debug-my-cv}
\item
...
Unfortunately you can't contact the future, yet. While we wait for the future to become more evenly distrubuted you \emph{can} contact me using the information below which includes directions to the Kilburn Buidling and parking information.
