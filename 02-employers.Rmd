...
## Employability
We're working hard to improve the employability of students because while having a Computer Science is necessary for some jobs, it is not sufficient. [@unemployed; @shadboltreview; @fincherreview; @finchergecco] Over the last 10 years the Department has tripled the number of our students going on year long placements in industry.
