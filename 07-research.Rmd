...
1. 2025-02-12 [Raising Representation CAHAE event](https://en.wikipedia.org/wiki/Wikipedia:Meetup/Raising_Representation_CAHAE_event), run in collaboration with the [Department of Classics, Ancient History, Archaeology and Egyptology](https://www.alc.manchester.ac.uk/cahae/) (CAHAE)
1. 2024-11-07 [Raising Representation](https://en.wikipedia.org/wiki/Wikipedia:Meetup/Raising_Representation) of Women in Archaeology, run in collaboration with Hannah Cobb
...
So, as of 2025, Tuning Complete are a [musical collective](https://en.wikipedia.org/wiki/Musical_collective) with a fluid membership model, we're always looking for new members to join our ensemble. Artists we have collaborated with include:
