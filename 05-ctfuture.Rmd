...
```{r echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captioncodingtheirfuture)"}
...
```{r echo = FALSE, fig.align = "center", out.width = "100%", fig.cap="(ref:captionraspberrypi)"}
