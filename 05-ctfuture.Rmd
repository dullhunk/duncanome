...
:  (\#tab:schooltable) Schools our undergraduate students have worked with in teaching computing in since 2013, ordered by the percentage of students entitled to free school meals (FSM). As of 2023, the UK average for students on FSM according to gov.uk is **23.8%**. [@averagefsm] This number has been increasing over the last decade as the UK falls behind on tackling child poverty [@childpoverty;@bbcfsm] 

+--------------------------------------------------------------------------------------+--------------+---------------------------------------+
|   School                                                                             | Location     | % FSM via gov.uk website              |
+======================================================================================+==============+=======================================+
...
+--------------------------------------------------------------------------------------+--------------+---------------------------------------+
| [pwhs.co.uk](https://pwhs.co.uk)                                                     | Didsbury     | [35.6%](https://bit.ly/didsburyhigh)  |
+--------------------------------------------------------------------------------------+--------------+---------------------------------------+
...
The project was setup by [Duncan Hull][Contact] and [David Rydeheard](http://www.cs.man.ac.uk/~david/) in 2013, and are now run and supervised by Duncan. There are lots of open questions about how Computer Science should be taught. [@cse; @suemcr; @stephenson; @fincherpetre] To find out more, see the [guidance for teachers] and [guidance for students] below.
