...
My office is in the Kilburn building. If you exit the building from the Lower First (LF) floor, go through the double doors, down the ramp on the South side of the building, see [bit.ly/Kilburn-lower-first-floor](https://bit.ly/Kilburn-lower-first-floor).
