...
If you're emailing `soe.x@manchester.ac.uk` you're query can be dealt with more quickly if you state your student ID and the fact that you are a Computer Science student, as these a centralised School of Engineering (`soe`) contacts.
