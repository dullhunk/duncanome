...
```
(ref:captionreferee) Not *that* kind of [referee](https://en.wikipedia.org/wiki/Referee), but a referee does provide facts and independent opinions about you. Whoever your referee is, if you don't ask their permission beforehand, you may receive a (virtual) [penalty card](https://en.wikipedia.org/wiki/Penalty_card) from your referee. CC BY image of a referee by Jason Gulledge on Wikimedia Commons [w.wiki/3dqE](https://w.wiki/3dqE) adapted using the [Wikipedia app](https://apps.apple.com/us/app/wikipedia/id324715238)
