...
```
(ref:captionkilburnsouth) A panoramic picture of the South entrance of the [Kilburn building](https://en.wikipedia.org/wiki/Kilburn_Building) on Wilton Street with the [Oxford Road](https://en.wikipedia.org/wiki/Wilmslow_Road) on the left and the [Alan Turing Building](https://en.wikipedia.org/wiki/Alan_Turing_Building) on the right hand side of the picture. CC BY SA picture from Wikimedia Commons.
