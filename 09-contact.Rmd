...
Unfortunately you can't contact the future, yet. While we wait for the future to become more evenly distributed you *can* contact me using the information below which includes directions to the Kilburn Buidling and parking information.
...
<!--[wiki.cs.manchester.ac.uk/index.php/UGHandbook23:Main](https://wiki.cs.manchester.ac.uk/index.php/UGHandbook23:Main)-->

* The Undergraduate (UG) Virtual Common Room [bit.ly/UG-VC-2025-26](https://bit.ly/UG-VC-2025-26) and links it contains, in particular: 
    +  The Undergraduate (UG) Handbook [bit.ly/UG-handbook-2025-26](https://bit.ly/UG-handbook-2025-26)
    + The Placement Handbook [bit.ly/placement-handbook-2025](https://bit.ly/placement-handbook-2025) 
    + The Monday Mail [studentnet.cs.manchester.ac.uk/ugt/mondaymail](https://studentnet.cs.manchester.ac.uk/ugt/mondaymail)
    + The Wednesday Waggle (for jobs) [waggle.cs.manchester.ac.uk](https://waggle.cs.manchester.ac.uk/waggle/login)
...
You can do this via [bit.ly/student-services-enquiry-form](https://bit.ly/student-services-enquiry-form)
...
```
(ref:captionkilburnarama) A panoramic picture of the [Kilburn building](https://en.wikipedia.org/wiki/Kilburn_Building) which looks a like a giant brick [heat sink](https://en.wikipedia.org/wiki/Heat_sink). This picture is taken from the [Oxford Road](https://en.wikipedia.org/wiki/Wilmslow_Road) showing [University Place](https://www.conference.manchester.ac.uk/venues/search/details/?property=10) on the right, which looks like a giant tin of baked beans. Creative Commons [BY](https://creativecommons.org/licenses/by/2.0/deed.en) Image by Yours Truly via Wikimedia Commons [w.wiki/E6Qk](https://w.wiki/E6Qk)
...
knitr::include_graphics("images/kilburn-south-entrance-new-door.jpg")
```
(ref:captionkilburnsouth) A panoramic picture of the South entrance of the [Kilburn building](https://en.wikipedia.org/wiki/Kilburn_Building) on Wilton Street with the [Oxford Road](https://en.wikipedia.org/wiki/Wilmslow_Road) on the left and the [Alan Turing Building](https://en.wikipedia.org/wiki/Alan_Turing_Building) on the right hand side of the picture.


## Kilburn Building Directions {#kilburn}

The [Kilburn building](https://en.wikipedia.org/wiki/Kilburn_Building) shown in figure \@ref(fig:kilburn-fig) is about 15 minutes walk from [Manchester Piccadilly](https://www.nationalrail.co.uk/stations_destinations/man.aspx) (MAN) or ten minutes from [Manchester Oxford Road](https://www.nationalrail.co.uk/stations/mco/details.aspx) (MCO). Our official postcode (M13 9PL) takes you to [University Place](http://www.conference.manchester.ac.uk/venues/search/details/?property=10) (which looks like a giant tin of baked beans) next door, so you're better off using the [what3words locations](https://www.bbc.co.uk/news/uk-england-49319760) [@what3words] below which are more accurate:
