...
A vertical tutor group will typically contain five members as shown in Figure~\@ref(fig:verticalfig). The group meets physically where possible, or virtually via a slack channel which consists of:
