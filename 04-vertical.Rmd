...
We are currently piloting a vertical tutoring (VT) system for undergraduate students. VT is already widespread in secondary education (see [verticaltutoring.org](https://www.verticaltutoring.org/)), [@vtbernard] but as far as we know has not been used in higher education.
...
6. What kind of specialist groups could be useful e.g. all female groups, research focussed tutorial groups (with MSc & PhD students), ordinary “vanilla” groups etc
