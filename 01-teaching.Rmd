...
If you'd like to debug your CV, application form, covering letter and job search etc, read [debugging your future](https://www.cdyf.me/debugging.html) [@debugyourfuture] and [reviewing their future](https://www.cdyf.me/reviewing.html) [@readingtheirfuture], especially if you haven't written a CV (two pages), résumé (one page) or LinkedIn profile before. Once you've done this you can send me any relevant documentation and then:
...
* Supervising final year educational projects based in secondary schools in Greater Manchester, see [coding their future](http://www.cs.man.ac.uk/~hulld/coding-their-future.html). [@computinged] 👩‍💻👨‍💻
