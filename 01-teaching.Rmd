...
If you'd like to debug your CV, application form, covering letter and job search etc, read [debugging your future](https://www.cdyf.me/debugging.html) [@debugyourfuture] and [reading their future](https://www.cdyf.me/sampling.html) [@readingtheirfuture], especially if you haven't written a CV (two pages), résumé (one page) or LinkedIn profile before. Once you've done this you can send me any relevant documentation and then:
