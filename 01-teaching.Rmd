...
I teach, mentor, tutor, lecture on and supervise a variety of undergraduate and postgraduate courses. You can find me online during office hours, in the labs, my office, [on YouTube](https://www.youtube.com/channel/UCLBv_u8JmyUPqmRALIjVnLg) and in the lecture theatre. 🎭
...
If you'd like to debug your CV, application form, covering letter and job search etc, read [debugging your future](https://www.cdyf.me/debugging.html) [@debugyourfuture] and [hacking your future](https://www.cdyf.me/hacking.html) [@hackingyourfuture], especially if you haven't written a CV, Résumé or LinkedIn profile before. Once you've done this you can send me any relevant documentation and then:
...
(ref:captionbuggingcv) Is that a bug or a feature in your CV? It's important to [debug your CV](https://www.cdyf.me/debugging.html) before an employer sees it, see the Wednesday Waggle for details of my weekly live debugging sessions. Features not bugs picture by [Visual Thinkery](https://visualthinkery.com) is licensed under [CC-BY-ND](https://creativecommons.org/licenses/by-nd/4.0/)  
...
* Supervising final year educational projects based in secondary schools in Greater Manchester, see [coding their future](https://personalpages.manchester.ac.uk/staff/duncan.hull/coding-their-future.html). [@computinged] 👩‍💻👨‍💻
